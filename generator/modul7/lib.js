...
function mcq(n, q, opts) {
  ...
  const rows = [new TableRow({ cantSplit: true, children: o.map(t => cell(t, { w: 2409, borders: brd('DDDDDD'), size: 19, sp: 20 })) })];
  return [new Paragraph({ keepNext: true, spacing: sp(90, 40), children: [new TextRun({ text: `${n}.  ${q}`, bold: true, size: 20 }),
